            ...
            <form class="m-5"  method="POST">
                <div class="row">
                    <div class="form-group col-md-6 mt-3">
                        ...
                        <input type="radio" name="staj_durum" value="Staj Onaylandı">Staj Onaylandı<br>
                        <input type="radio" name="staj_durum" value="Staj Reddedildi">Staj Reddedildi
                    </div>
                    <div class="form-group col-md-6 mt-3">
                        <label for="staj_durum">Reddedilme Nedeni:</label><br>
                        <textarea id="red_neden" name="red_neden" rows="4" cols="50"></textarea>
                    </div>
...
<?php
        if (isset($_POST["staj_onay_durum"])) {
            $staj_onay_durum=$db->prepare("update basvuru set
