...
<div class="row">
       ...
       <div class="mb-3 m-1 mb-md-0 me-md-auto text-white text-decoration-none border p-2">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                <?php
                        echo "<a href='/staj-takip/student/stajDefterUpload.php?ogrenci_no=".$_SESSION["kullanici_no"]."' class='nav-link text-white active' >
      ...
      <div class="col-md-9">
            <h3 class="text-center mt-5">Staj Defteri ve Diğer Belgeleri Yükleme</h3>
            <form class="m-5"  method="POST">
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        <label class="text-dark" for="file">Staj Defteri ve Diğer Belgeleri Drive Linki:</label>
                        <input class="form-control" type="text" name="staj_defter" id="staj_defter" placeholder="Dosya linkini girin.." value="<?php echo $satir['staj_defter']; ?>" required>
                    </div>
