      ...
      <div class="col-md-9">
            ...
            <form class="m-5"  method="POST">
                ...
                <div class="form-group col-md-6 mt-3">
                        ...
                        <input class="form-control" disabled type="text" name="staj_tur" id="staj_tur" value="<?php echo $satir['staj_tur']; ?>">
                      </div>
                      <div class="form-group col-md-6 mt-3">
                        <label class="text-dark" for="gunsayisi">Staj gün sayısı:</label>
                        <input class="form-control" disabled type="text" name="is_gunu" id="is_gunu" value="<?php echo $satir['is_gunu']; ?>">
                    </div>
                    <div class="form-group col-md-6 mt-3">
                        <label class="text-dark" for="baslangicgunu" >Staj başlangıç tarihi:</label>
                        <input class="form-control" disabled type="date" name="baslangic_gunu" min="2002-09-09" id="baslangic_gunu" value="<?php echo $satir['baslangic_gunu']; ?>">
                    </div>
                    <div class="form-group col-md-6 mt-3">
                        <label class="text-dark" for="bitisgunu">Staj bitiş tarihi:</label>
                        <input class="form-control" disabled type="date" name="bitis_gunu" min="2002-09-09" id="bitis_gunu" value="<?php echo $satir['bitis_gunu']; ?>" >
                    </div>
                    <div class="form-group col-md-12 mt-3" >
                        <label class="text-dark">Staj Belgesi:</label>
                        <div  class="form-group p-2 " style="background-color:#E8F0FE; border-radius:24px;">
                        <a href="<?php echo $satir['file']; ?>" target="_blank"> <?php echo $satir['file']; ?> </a>
                        </div>
                    </div>
                </div>
              </form>
